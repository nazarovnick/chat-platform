...
import (
	...
	"github.com/nazarovnick/chat-platform/services/friendship/internal/controller/grpc/v1/friendship"
	"github.com/nazarovnick/chat-platform/services/friendship/internal/controller/http"
...
func main() {
	...
	go func() {
		...
		pb.RegisterFriendshipServiceServer(grpcServer, impl)
	...
	go func() {
		...
		if err = pb.RegisterFriendshipServiceHandlerServer(ctx, gwMux, impl); err != nil {
			log.Fatalf("failed to serve: %v", err)
		}
